...
title = "SIMPL"
type = "cv/experience"
skills = ['application-design', 'infrastructure', 'linux', 'networking', 'security', 'service-orchestration', 'shell', 'web-dev']
tools = ['aws', 'grafana', 'github-actions', 'terraform', 'turso'] # add page for Confluent
tags = []
