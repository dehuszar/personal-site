...
PostCSS appears to be settling down into maintenance mode, but there does not appear to be much of an heir-apparent, and its popularity not completely waned. I'm more than happy to hand-roll artisanal stylesheets, but when life would be easier with a little help, PostCSS is my go-to.
