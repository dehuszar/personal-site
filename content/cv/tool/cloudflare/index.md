...
It is particularly helpful for multi-cloud architectures to have a DNS and routing layer that lives outside of any one of cloud offerings being routed to. Should AWS us-east-1 go down, and the service is mirrored on GCP--or vice-versa, it's safer to not try to negotiate that on either AWS or GCP's internal systems.
